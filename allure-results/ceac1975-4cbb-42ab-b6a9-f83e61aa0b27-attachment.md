...
- Name: View Product
- Location: C:\Users\HP\Desktop\automation-exercise\tests\viewProduct.spec.js:4:9
...
```ts
   ...
   3 |
>  4 |     test('View Product', async ({page}) => {
     |         ^ Error: browserType.launch: Executable doesn't exist at C:\Users\HP\AppData\Local\ms-playwright\chromium_headless_shell-1169\chrome-win\headless_shell.exe
   ...
   9 |         await productPage.viewProduct()
  10 |         await productPage.validateViewedProductName()
  11 |         
  12 |     })
```